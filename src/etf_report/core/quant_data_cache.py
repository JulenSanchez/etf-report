...
from etf_report.core.paths import DATA_DIR as PROJECT_DATA_DIR, PROJECT_ROOT, SCRIPTS_DIR

DATA_DIR = PROJECT_DATA_DIR / "quant"
CACHE_DIR = PROJECT_ROOT / "data" / "backtest_cache"

from etf_report.core.quant_data_utils import load_etf_data as _load_etf_csv
from etf_report.core.benchmark_data import load_hs300_daily_cached, build_hs300_weekly, build_ma_trend_cache
