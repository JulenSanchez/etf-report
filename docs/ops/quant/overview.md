...
| 正式页量化展示 | `assets/js/quant-main.js` | `docs/ops/report.md` |
| 日常自动化 / preclose push | `BatchFiles/` + `scripts/preclose_push.py` | `docs/ops/quant/daily-automation.md` |
...
| 症状 | 优先看 |
|---|---|
| Tuner 白屏 / API 报错 | `docs/ops/quant/tuner.md` |
| CSV 缺失 / 数据不新 | `docs/ops/quant/data-fetch.md` |
| preclose push 失败 | `docs/ops/quant/daily-automation.md` |
| ETF 池变更后回测异常 | `docs/ops/pool-change.md` |
| 正式页量化为空 | `docs/ops/report.md` |

## 相关文档

- Tuner 运维：`docs/ops/quant/tuner.md`
